...
class CoinexPerpetualApi(object):
    ...
    def adjust_stopLoss(self, market, stop_type, position_id, stop_loss_price):
        """
        # params:
            market	String	Yes	合约市场, 例如：BTCUSD
            stop_type	String	Yes	
            stop_loss_type integer yes
            position_id	Integer	Y	1 逐仓 2 全仓
...
"data": {
    ...
    def adjust_takeProfit(self, market, stop_type, position_id, take_profit_price):
        """
        # params:
            market	String	Yes	合约市场, 例如：BTCUSD
            stop_type	String	Yes	
